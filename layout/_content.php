						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="row g-5 g-xl-8">
								...
								<?php include ('partials/widgets/engage/_widget-1.php') ?>

								<?php include  ('partials/widgets/lists/_widget-5.php') ?>
									...
									<div class="card  mb-xl-8">
										...
										<div class="card-body pt-5">
											...
											<div class="d-flex flex-stack">
												<!--begin::Title-->
												<h4 class="fw-bolder text-gray-800 m-0">Following Target</h4>
												<!--end::Title-->
											...
											<div class="text-center w-100 position-relative z-index-1" style="margin-top: -130px">
												<!--begin::Text-->
												<p class="fw-bold fs-4 text-gray-400 mb-6">You currently have
												<br />8,346 followers</p>
												<!--end::Text-->
												<!--begin::Action-->
												<div class="mb-9 mb-xxl-1">
													<a href='#' class="btn btn-success fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">10,000 followers</a>
												</div>
												<!--ed::Action-->
											</div>
											<!--end::Content-->
										...
										<div class="card-footer d-flex flex-center py-5">
											...
											<div class="d-flex align-items-center flex-shrink-0 me-7 me-lg-12">
												...
												<!--end::Bullet-->
												<!--begin::Label-->
												<span class="fw-bold text-gray-400 fs-6">Current Following</span>
												<!--end::Label-->
											</div>
											<!--ed::Item-->
											<!--begin::Item-->
											<div class="d-flex align-items-center flex-shrink-0">
												...
												<!--end::Bullet-->
												<!--begin::Label-->
												<span class="fw-bold text-gray-400 fs-6">Target Following</span>
												<!--end::Label-->
											</div>
											<!--ed::Item-->
										</div>
...
<div class="card mb-xl-8">
										...
										<div class="card-body p-0">
											<div class="d-flex flex-stack card-p flex-grow-1">
												...
												<div class="d-flex flex-column text-end">
													<span class="text-dark fw-bolder fs-2">760 followers</span>
													<span class="text-muted fw-bold mt-1">Total Followers</span>
												</div>
											</div>
									...
									<a href="#" class="card bg-danger hoverable card mb-xl-8">
										<!--begin::Body-->
										<div class="card-body">
											...
											<!--end::Svg Icon-->
											<div class="text-white fw-bolder fs-2 mb-2 mt-5">Marketing Brief</div>
											<div class="fw-bold text-white">Brand Overview</div>
										</div>
										<!--end::Body-->
									</a>
													...
													<div class="mt-5">
														...
														<div class="d-flex flex-stack mb-5">
															...
															<div class="d-flex align-items-center me-2">
																...
																<!--begin::Title-->
																<div>
																	<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Social Media Hashtags</a>
																	<div class="fs-7 text-muted fw-bold mt-1">#helloworld #devworld #codemore</div>
																</div>
																<!--end::Title-->
															</div>
															<!--end::Section-->
														...
														<div class="d-flex flex-stack mb-5">
															...
															<div class="d-flex align-items-center me-2">
																...
																<!--begin::Title-->
																<div>
																	<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Topics</a>
																	<div class="fs-7 text-muted fw-bold mt-1">Tech Startups, Tech in Ghana</div>
																</div>
																<!--end::Title-->
															</div>
															<!--end::Section-->
														...
														<div class="d-flex flex-stack">
															...
															<div class="d-flex align-items-center me-2">
																...
																<!--begin::Title-->
																<div class="py-1">
																	<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Industry Trends</a>
																	<div class="fs-7 text-muted fw-bold mt-1">Kids who code</div>
																</div>
																<!--end::Title-->
															</div>
															<!--end::Section-->
...
<div class="card mb-5 mb-xl-8">
									...
									<div class="card  mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Engagement</span>
												<span class="text-muted fw-bold fs-7">Reach and Likes</span>
											</h3>
									...
									<div class="card  mb-xl-8">
										...
										<div class="card-body p-0">
											<div class="d-flex flex-stack card-p flex-grow-1">
												...
												<div class="d-flex flex-column text-end">
													<span class="text-dark fw-bolder fs-2">600 </span>
													<span class="text-muted fw-bold mt-1">Weekly Reach</span>
												</div>
											</div>
							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="card">
									...
									<div class="card-header">
										<h2 class="card-title fw-bolder">Your Schedule with Simliexpand</h2>
										<div class="card-toolbar">

								...
								<div class="d-flex align-items-center py-3 py-lg-0">
									<div class="me-3">
										<a href="#" class="btn btn-icon btn-custom btn-active-color-primary position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											...
											<!--end::Svg Icon-->
											<small class="bullet bullet-dot bg-danger h-20px w-20px position-absolute translate-middle top-0 start-100 text-white">24</small>
										</a>

<?php include 'topbar/partials/_notifications-menu.php'  ?>
...
<?php include 'topbar/partials/_user-menu.php'  ?>

									</div>
									<a href="#" class="btn btn-success" data-bs-target="#kt_modal_create_app" data-bs-toggle="modal">Payment Status</a>
								</div>
								<!--end::Action-->
							</div>
							<!--end::Wrapper-->

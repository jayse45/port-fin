<div class="container-xxl" id="kt_content_container">
								...
								<div class="card-body pt-9 pb-0">
									...
									<div class="d-flex flex-wrap flex-sm-nowrap mb-6">
										...
										<div class="d-flex flex-center flex-shrink-0 bg-light rounded w-100px h-100px w-lg-150px h-lg-150px me-7 mb-4">
											<img class="mw-50px mw-lg-75px" src="assets/media/logos/logo3x3.png" alt="image" />
										</div>
										<!--end::Image-->
										<!--begin::Wrapper-->
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-1">
														<a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bolder me-3">Facebook Analytics</a>
														<span class="badge badge-light-success me-auto">In Progress</span>
													</div>
													<!--end::Status-->
													<!--begin::Description-->
													<div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400">Welcome Simpliexpand</div>
													<!--end::Description-->
												</div>
												<!--end::Details-->
											...
											<div class="d-flex flex-wrap justify-content-start">
												...
												<div class="d-flex flex-wrap">
													...
													<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
														...
														<!--end::Number-->
														<!--begin::Label-->
														<div class="fw-bold fs-6 text-gray-400">Date</div>
														<!--end::Label-->
													</div>
													<!--end::Stat-->
													<!--begin::Stat-->
													<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
														...
														<!--end::Number-->
														<!--begin::Label-->
														<div class="fw-bold fs-6 text-gray-400">Page Following</div>
														<!--end::Label-->
													</div>
													<!--end::Stat-->
													<!--begin::Stat-->
													<div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
														...
														<!--end::Number-->
														<!--begin::Label-->
														<div class="fw-bold fs-6 text-gray-400">Page Likes</div>
														<!--end::Label-->
													</div>
													<!--end::Stat-->
												</div>
									...
									<div class="d-flex overflow-auto h-55px">
										...
										<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
											<!--begin::Nav item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary me-6 active" data-bs-toggle="tab" href="#kt_project_targets_card_pane">Overview</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary me-6 " data-bs-toggle="tab" href="#kt_project_targets_demograph_pane">Demographics</a>
											</li>
											<!--end::Nav item-->
											<!--begin::Nav item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary me-6 " data-bs-toggle="tab" href="#kt_project_targets_table_pane">Paid</a>
											</li>
											<!--end::Nav item-->
							...
							<div class="tab-content" style="margin-top: 30px;">
								...
								<div class="card card-xl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Facebook Followers</span>
												<span class="text-muted fw-bold fs-7">December</span>
											</h3>
								...
								<div class="card card-xl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Facebook Likes</span>
												<span class="text-muted fw-bold fs-7">December</span>
											</h3>
								...
								<!--end::Tab Overview pane-->



								<!--begin::Tab Demographics pane-->
								<div id="kt_project_targets_demograph_pane" class="tab-pane fade">
							...
							<div class="row g-5 g-xxl-8">
								...
								<div class="col-xl-6">
									...
									<div class="card mb-5 mb-xxl-8">
										...
										<div class="card-body">
											<!--begin::Chart-->
											<div id="kt_charts_widget_112" style="height: 350px"></div>
											<!--end::Chart-->
										</div>
										<!--end::Body-->
									</div>

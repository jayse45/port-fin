						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="d-flex flex-column flex-lg-row">
														...
														<table class="table fs-6 fw-bold gs-0 gy-2 gx-2 m-0">
															...
															<tbody><tr>
																...
																<td class="text-gray-800 min-w-200px">
																	<a href="../../demo9/dist/pages/apps/customers/view.html" class="text-gray-800 text-hover-primary">e.smith@kpmg.com.au</a>
																</td>
															</tr>
															<!--end::Row-->
															<!--begin::Row-->
								...
								<div class="flex-column flex-lg-row-auto w-lg-250px w-xl-300px mb-10 order-1 order-lg-2">
									<!--begin::Card-->
									<div class="card card-flush mb-0" data-kt-sticky="" data-kt-sticky-name="subscription-summary" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', xl: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
										<!--begin::Card header-->
										<div class="card-header">
											<!--begin::Card title-->
											<div class="card-title">
